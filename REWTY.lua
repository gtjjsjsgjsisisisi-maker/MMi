-- EuroXChok UI Library (Mobile & Delta Executor Optimized)
local UserInputService = game:GetService("UserInputService")
local TweenService = game:GetService("TweenService")
local CoreGui = game:GetService("CoreGui")

-- ดึง Parent สำหรับ Delta / Mobile Executors
...
-- ระบบ Dragging รองรับทั้ง Mouse และ Touch Screen
...
function EuroXChok:CreateWindow(Settings)
    ...
    -- ปุ่มวงกลมลอยสำหรับกดเปิด-ปิด UI บนมือถือ
